  ...
  return (
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <StyledInternalLink
          to={`/stake/${currencyId(token0.chainId, currency0)}/${currencyId(token0.chainId, currency1)}`}
          style={{ width: '100%' }}
        >
      ...
      <StatContainer>
        ...
        {/* <RowBetween>
          ...
          <TYPE.white>{`${stakingInfo.totalRewardRate
            ?.multiply(`${60 * 60 * 24 * 7}`)
            ?.toFixed(0, { groupSeparator: ',' })} SAD / ${t('week')}`}</TYPE.white>
        </RowBetween> */}
      </StatContainer>
          ...
          <BottomSection showBackground={true}>
            ...
            <TYPE.black style={{ textAlign: 'right' }} color={'white'} fontWeight={500}>
              ...
              {`${stakingInfo.rewardRate
                ?.multiply(`${60 * 60 * 24 * 7}`)
                ?.toSignificant(4, { groupSeparator: ',' })} SAD / ${t('week')}`}
            </TYPE.black>
          </BottomSection>
        </>
      )} */}
