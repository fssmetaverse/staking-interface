        ...
        <ContentWrapper gap="lg">
          ...
          {stakingInfo?.earnedAmount && (
            <AutoColumn justify="center" gap="md">
              ...
              <TYPE.body>{t('Unclaimed')} SAD</TYPE.body>
            </AutoColumn>
          )}
          <TYPE.subHeader style={{ textAlign: 'center' }}>
            {t('When you withdraw, your SAD is claimed and your liquidity is removed from the mining pool.')}
          </TYPE.subHeader>
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOndismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>
              {t('Claiming')} {stakingInfo?.earnedAmount?.toSignificant(4)} SAD
            </TYPE.body>
          </AutoColumn>
        </LoadingView>
      )}
      {hash && (
        <SubmittedView onDismiss={wrappedOndismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>{t('Claimed')} SAD!</TYPE.body>
          </AutoColumn>
        </SubmittedView>
      )}
    </Modal>
