...
export function useDerivedSwapInfo(): {
  ...
  // 禁用SAD交易
  // const SADAddressStr = chainId ? SAD_ADDRESS[chainId] : SAD_ADDRESS[ChainId.HECO_MAINNET]
  // if (SADAddressStr === inputCurrencyId) {
  //   inputError = inputError ?? t('SAD is not tradable')
  // }

  // if (v2Trade && SADAddressStr === inputCurrencyId) {
